...
class Desafio {
    static void Main() {
        let chico =         * Int32.Parse(Console.ReadLine());
        let bento =        * Int32.Parse(Console.ReadLine());
        let bernardo =    * Int32.Parse(Console.ReadLine());
        let marina =        * Int32.Parse(Console.ReadLine());
        let iara =           * Int32.Parse(Console.ReadLine());
        let marlene = 
        let total = 
